# -*- coding: utf-8 -*-
"""
Created on Mon Nov 23 22:02:05 2015
...
data1=[float(i)for i in file('flow1.txt','r').readlines()[-ds*5:]]
data2=[float(i)*2for i in file('flow2.txt','r').readlines()[-ds*5:]]
data3=[float(i)*2for i in file('flow3.txt','r').readlines()[-ds*5:]]
...
# plt.savefig('compvol.pdf', dpi = 1200)
plt.show()
